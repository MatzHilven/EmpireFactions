...
public class FactionAllySubCommand implements SubCommand {

    private final EmpireFactions main;

    public FactionAllySubCommand(EmpireFactions main) {
        this.main = main;
    }
    ...
    public void onCommand(CommandSender sender, Command command, String[] args) {
        ...
        if (playerFaction.addAlly(faction)) {
            StringUtils.sendMessage(sender, Messager.ADDED_ALLY.replace("%faction%", faction.getNameColored()));
        } else {
