...
public class FactionMuteSubCommand implements SubCommand {

    private final EmpireFactions main;

    public FactionMuteSubCommand(EmpireFactions main) {
        this.main = main;
    }
    ...
    public void onCommand(CommandSender sender, Command command, String[] args) {
        ...
        faction.setMuted(true);

        faction.getOnline().forEach(player1 -> StringUtils.sendMessage(player1, Messager.MUTED_CHAT));
    }
