...
public class FactionNeutralSubCommand implements SubCommand {

    private final EmpireFactions main;

    public FactionNeutralSubCommand(EmpireFactions main) {
        this.main = main;
    }
    ...
    public void onCommand(CommandSender sender, Command command, String[] args) {
        ...
        playerFaction.removeAlly(faction);

        StringUtils.sendMessage(sender, Messager.REMOVED_ALLY.replace("%faction%", faction.getNameColored()));
    }
