...
public class FactionOpenSubCommand implements SubCommand {

    private final EmpireFactions main;

    public FactionOpenSubCommand(EmpireFactions main) {
        this.main = main;
    }
    ...
    public void onCommand(CommandSender sender, Command command, String[] args) {
        ...
        if (faction.isOpen()) {
            StringUtils.sendMessage(sender,Messager.OPEN);
        } else {
            StringUtils.sendMessage(sender,Messager.CLOSE);
        }
    }
